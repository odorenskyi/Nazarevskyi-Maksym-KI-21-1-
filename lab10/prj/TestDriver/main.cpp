...
int main()
{
    ...
    const string inputText[5] = { "Я - студент, помив руки 3 рази.",
                                  "8 Березня - це жіночий день, можна дарувати багато квітів, я подарував 9.",
                                  "Я успішно виконав 3 завдання з допомогою модулів.",
                                  "Моя програма працює успішно.",
                                  "Зараз у світі налічується 252 країни, але з них лише 195 держав"
                                };
    const int numberSymbols[5] = {25, 61, 42, 25, 52};
